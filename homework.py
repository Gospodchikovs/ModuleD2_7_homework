...
postcategory = PostCategory.objects.create(post=article1, category=category1)
postcategory = PostCategory.objects.create(post=article1, category=category2)

news1 = Post.objects.create(author=author1, type='NW', heading='News 1', body='News Body 1', rating=0)
postcategory = PostCategory.objects.create(post=news1, category=category3)
postcategory = PostCategory.objects.create(post=news1, category=category4)

news2 = Post.objects.create(author=author2, type='NW', heading='News 2', body='News Body 2', rating=0)
postcategory = PostCategory.objects.create(post=news2, category=category1)
